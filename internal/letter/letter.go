...
I request deletion of the following categories of personal data held by your organization in connection with my relationship/service with you:`
		...
		body = `I, the undersigned, am exercising my right to erasure of personal data under Section 8(6) of the Digital Personal Data Protection Act, 2023 (DPDP Act) 
...
Please confirm in writing (email preferred) once the deletion is complete, specifying the scope of data deleted.`
		...
		ack = `As required under Section 8(6) of the DPDP Act 2023, please acknowledge receipt of this request within 48 hours.

As required under Section 8(6), please complete the erasure of personal data within 30 days of this request.
...
As required under Section 8(6), please complete deletion within 30 days.
...
Generated by FinWipe | %s | Legal Basis: DPDPA 2023 + RBI DLG 2022`,
		...
		body = fmt.Sprintf(`I, %s, exercising my right to erasure under Section 8(6) of the Digital Personal Data Protection Act, 2023 (DPDP Act) and Section 8(6) of the DPDP Rules, 2025, hereby request deletion of the following categories of personal data held by your organization:
