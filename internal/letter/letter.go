...
func (l LegalBasis) Description() string {
	return map[LegalBasis]string{
		LegalBasisDPDP: "Sections 8(6) & 8(7), Digital Personal Data Protection Act, 2023",
		LegalBasisRBI:  "RBI Digital Lending Guidelines 2022 — Para 10.2, 11.1, 11.2",
		LegalBasisBoth: "Sections 8(6) & 8(7), DPDP Act 2023 + RBI DLG 2022 (Para 10.2, 11.1, 11.2)",
	}[l]
}
...
Please confirm in writing (email preferred) once the deletion is complete, specifying the scope of data deleted.`
		...
		ack = `Under Section 8(7) of the DPDP Act 2023, you must cease processing upon receipt of this withdrawal. Please acknowledge within 48 hours and confirm erasure completion within 30 days.

As required under Section 8(7) DPDP Act 2023, erasure must be completed within 30 days of this request.
...
Under Section 8(7) DPDP Act: complete erasure within 30 days.
...
Generated by FinWipe | %s | Legal Basis: DPDPA 2023 + RBI DLG 2022`,
		...
		subject = fmt.Sprintf("DPDP Act Sections 8(6) & 8(7) — Consent Withdrawal & Erasure Request [%s]", reqID)
		body = fmt.Sprintf(`I, %s, exercising my right to erasure under Sections 8(6) & 8(7) of the Digital Personal Data Protection Act, 2023 (DPDP Act) and Section 8(6) of the DPDP Rules, 2025, hereby request deletion of the following categories of personal data held by your organization:
...
I have not received acknowledgment of my deletion request within the 48-hour timeline mandated under Section 8(6) of the DPDP Act 2023.
...
2. Complete deletion within 30 days (Section 8(6))
...
func (g *Generator) GenerateVerification(requestID, entityName string, entity *nbfc.Entity, profile config.Profile, method, outputPath string) error {
	...
	pdf.SetFont("Arial", "", 10)
	pdf.CellFormat(0, 5, "Sections 8(6) & 8(7), Digital Personal Data Protection Act, 2023", "", 1, "C", false, 0, "")
